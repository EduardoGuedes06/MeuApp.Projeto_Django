...
class UnidadeSolicitante(models.Model):
    ...
    user = models.ManyToOneRel('user', User, field_name='users')
    # createdBy_user = models.ForeignKey(User, models.PROTECT)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class VagaOfertada(models.Model):
    ...
    paciente= models.ForeignKey(Paciente, on_delete=models.PROTECT, null=True, blank=True, verbose_name="Nome do Paciente")
    data_vagaOfertada = models.DateField(verbose_name="Data")
    hora_vagaOfertada = models.TimeField(verbose_name="Hora")
    procedimento = models.ForeignKey(Procedimento, on_delete=models.PROTECT, null=True, blank=True, verbose_name="Procedimento")    
    unidadeExecutante = models.ForeignKey(UnidadeExecutante, on_delete=models.PROTECT, null=True, blank=True, verbose_name="Unidade Executante")
